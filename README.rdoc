...
Ryan updated his gem and now it's compatible with Rails 3.0. 

Please, use Ryan's version instead of populator3 — https://github.com/ryanb/populator.
...
Original project by Ryan Bates at http://github.com/ryanb/populator.
This project can be found on github at the following URL.

Forked and switched to Rails 3 by Alex Zinchenko (http://github.com/yumitsu).
Feel free to send founded bugs to issue tracker at GitHub.

If you want to help me to maintain this project, please fork the project and send a pull request.
